...
package com.powernusa.andy.xyzreader.data;
...
public class ItemsProvider extends ContentProvider {
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		final com.powernusa.andy.xyzreader.data.SelectionBuilder builder = buildSelection(uri);
	...
	private com.powernusa.andy.xyzreader.data.SelectionBuilder buildSelection(Uri uri) {
		final com.powernusa.andy.xyzreader.data.SelectionBuilder builder = new com.powernusa.andy.xyzreader.data.SelectionBuilder();
		final int match = sUriMatcher.match(uri);
		return buildSelection(uri, match, builder);
	}

	private com.powernusa.andy.xyzreader.data.SelectionBuilder buildSelection(Uri uri, int match, com.powernusa.andy.xyzreader.data.SelectionBuilder builder) {
